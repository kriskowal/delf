...
var InflatableText = require('./inflatable-text');

var element = document.querySelector('#deadcenter');
var component = new InflatableText(element);
window.addEventListener('resize', handleResize);
handleResize();

function handleResize() {
    component.reflow(new Region2(
        new Point2(0, 0),
...
CommandHandler.prototype.destruct = function () {
    Object.keys(this.eventHandlerNames).forEach(function (eventName) {
...
RestMode.prototype.handleCommand = function (command) {
    if (command.type === 'go') {
        ...
        var vector = command.direction.vector.mul(viewportSize);
...
KeyHandler.prototype.destruct = function () {
