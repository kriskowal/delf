...
}],["essays/tiles/index.js","delf/essays/tiles","index.js",{"gutentag/document":9,"gutentag/scope":10,"blick":0,"../../lib/attention":4,"./root.html":2,"../../lib/timers":8,"ndim/point2":15,"ndim/region2":17},function (require, exports, module, __filename, __dirname){

// delf/essays/tiles/index.js
// --------------------------
...
}],["essays/tiles/root.html","delf/essays/tiles","root.html",{"./root.js":3,"gutentag/text.html":11,"../../lib/tiles.html":6},function (require, exports, module, __filename, __dirname){

// delf/essays/tiles/root.html
// ---------------------------
...
var $THIS = function DelfEssaysTilesRoot(body, caller) {
    ...
    if (component.setAttribute) {
        component.setAttribute("id", "origin_nawdec");
    }
    if (scope.componentsFor["origin"]) {
       scope.componentsFor["origin"].setAttribute("for", "origin_nawdec")
    }
    if (component.setAttribute) {
    ...
    // DIV
        ...
        if (component.setAttribute) {
            component.setAttribute("id", "tiles_jdd64d");
        }
        if (scope.componentsFor["tiles"]) {
           scope.componentsFor["tiles"].setAttribute("for", "tiles_jdd64d")
        }
        if (component.setAttribute) {
        component.setAttribute("class", "tiles");
        }
        parents[parents.length] = parent; parent = node;
        // DIV
            node = document.createElement("DIV");
            ...
            // DIV
                ...
                scope.hookup("tiles", component);
                if (component.setAttribute) {
                    component.setAttribute("id", "tiles_8052zx");
                }
                if (scope.componentsFor["tiles"]) {
                   scope.componentsFor["tiles"].setAttribute("for", "tiles_8052zx")
                }
            node = parent; parent = parents[parents.length - 1]; parents.length--;
            node = document.createElement("DIV");
            parent.appendChild(node);
            component = node.actualNode;
            if (component.setAttribute) {
            component.setAttribute("class", "tiles2box");
            }
            parents[parents.length] = parent; parent = node;
            // DIV
                node = document.createBody();
                ...
                // TILES
                    ...
                    component = new $TILES(parent, callee);
                node = parent; parent = parents[parents.length - 1]; parents.length--;
                scope.hookup("tiles2", component);
                if (component.setAttribute) {
                    component.setAttribute("id", "tiles2_fgp6ji");
                }
                if (scope.componentsFor["tiles2"]) {
                   scope.componentsFor["tiles2"].setAttribute("for", "tiles2_fgp6ji")
                }
            node = parent; parent = parents[parents.length - 1]; parents.length--;
        node = parent; parent = parents[parents.length - 1]; parents.length--;
    node = parent; parent = parents[parents.length - 1]; parents.length--;
...
module.exports = $THIS;
var $THIS$0 = function DelfEssaysTilesRoot$0(body, caller) {
    var document = body.ownerDocument;
    ...
    if (component.setAttribute) {
        component.setAttribute("id", "coord_9fop7b");
    }
    if (scope.componentsFor["coord"]) {
       scope.componentsFor["coord"].setAttribute("for", "coord_9fop7b")
    }
};
var $THIS$1 = function DelfEssaysTilesRoot$1(body, caller) {
    var document = body.ownerDocument;
    var scope = this.scope = caller;
    var parent = body, parents = [], node, component, callee, argument;
    node = document.createBody();
    ...
    scope.hookup("coord", component);
    if (component.setAttribute) {
        component.setAttribute("id", "coord_lhy7lh");
    }
    if (scope.componentsFor["coord"]) {
       scope.componentsFor["coord"].setAttribute("for", "coord_lhy7lh")
    }
};

}],["essays/tiles/root.js","delf/essays/tiles","root.js",{"ndim/point2":15,"ndim/region2":17,"../../lib/drag":5},function (require, exports, module, __filename, __dirname){

// delf/essays/tiles/root.js
// -------------------------
...
}],["lib/tiles.html","delf/lib","tiles.html",{"./tiles":7},function (require, exports, module, __filename, __dirname){
...
}],["lib/tiles.js","delf/lib","tiles.js",{"ndim/point2":15,"ndim/region2":17},function (require, exports, module, __filename, __dirname){
