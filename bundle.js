...
var $THIS = function ColorimhtmlColorim(body, caller) {
    ...
    if (component.setAttribute) {
        component.setAttribute("id", "container_x0i1at");
    }
    if (scope.componentsFor["container"]) {
       scope.componentsFor["container"].setAttribute("for", "container_x0i1at")
    }
    ...
    // DIV
        ...
        if (component.setAttribute) {
            component.setAttribute("id", "center_47egir");
        }
        if (scope.componentsFor["center"]) {
           scope.componentsFor["center"].setAttribute("for", "center_47egir")
        }
        parents[parents.length] = parent; parent = node;
        // DIV
            node = document.createElement("DIV");
            ...
            // DIV
                ...
                if (component.setAttribute) {
                    component.setAttribute("id", "hueSpectrum_i98vfb");
                }
                if (scope.componentsFor["hueSpectrum"]) {
                   scope.componentsFor["hueSpectrum"].setAttribute("for", "hueSpectrum_i98vfb")
                }
            node = parent; parent = parents[parents.length - 1]; parents.length--;
            node = document.createElement("DIV");
            parent.appendChild(node);
            ...
            // DIV
                ...
                if (component.setAttribute) {
                    component.setAttribute("id", "saturationSpectrum_m1k099");
                }
                if (scope.componentsFor["saturationSpectrum"]) {
                   scope.componentsFor["saturationSpectrum"].setAttribute("for", "saturationSpectrum_m1k099")
                }
            node = parent; parent = parents[parents.length - 1]; parents.length--;
            node = document.createElement("DIV");
            parent.appendChild(node);
            ...
            // DIV
                ...
                if (component.setAttribute) {
                    component.setAttribute("id", "lightnessSpectrum_v0jxxj");
                }
                if (scope.componentsFor["lightnessSpectrum"]) {
                   scope.componentsFor["lightnessSpectrum"].setAttribute("for", "lightnessSpectrum_v0jxxj")
                }
            node = parent; parent = parents[parents.length - 1]; parents.length--;
        node = parent; parent = parents[parents.length - 1]; parents.length--;
    node = parent; parent = parents[parents.length - 1]; parents.length--;
...
var $THIS = function ColorimhtmlHuespectrum(body, caller) {
    ...
    // DIV
        ...
        if (component.setAttribute) {
            component.setAttribute("id", "spectrum_rree4v");
        }
        if (scope.componentsFor["spectrum"]) {
           scope.componentsFor["spectrum"].setAttribute("for", "spectrum_rree4v")
        }
    node = parent; parent = parents[parents.length - 1]; parents.length--;
    node = document.createElement("DIV");
    parent.appendChild(node);
    ...
    if (component.setAttribute) {
        component.setAttribute("id", "reticle_ir7sux");
    }
    if (scope.componentsFor["reticle"]) {
       scope.componentsFor["reticle"].setAttribute("for", "reticle_ir7sux")
    }
    parents[parents.length] = parent; parent = node;
    // DIV
    node = parent; parent = parents[parents.length - 1]; parents.length--;
...
var $THIS$0 = function ColorimhtmlHuespectrum$0(body, caller) {
    ...
    if (component.setAttribute) {
        component.setAttribute("id", "swatch_mmwdyp");
    }
    if (scope.componentsFor["swatch"]) {
       scope.componentsFor["swatch"].setAttribute("for", "swatch_mmwdyp")
    }
    parents[parents.length] = parent; parent = node;
    // DIV
    node = parent; parent = parents[parents.length - 1]; parents.length--;
...
var $THIS = function ColorimhtmlSpectrum(body, caller) {
    ...
    // DIV
        ...
        scope.hookup("spectrum", component);
        if (component.setAttribute) {
            component.setAttribute("id", "spectrum_kfimbl");
        }
        if (scope.componentsFor["spectrum"]) {
           scope.componentsFor["spectrum"].setAttribute("for", "spectrum_kfimbl")
        }
    node = parent; parent = parents[parents.length - 1]; parents.length--;
    node = document.createElement("DIV");
    parent.appendChild(node);
    ...
    if (component.setAttribute) {
        component.setAttribute("id", "reticle_7hap5k");
    }
    if (scope.componentsFor["reticle"]) {
       scope.componentsFor["reticle"].setAttribute("for", "reticle_7hap5k")
    }
    parents[parents.length] = parent; parent = node;
    // DIV
    node = parent; parent = parents[parents.length - 1]; parents.length--;
...
var $THIS$0 = function ColorimhtmlSpectrum$0(body, caller) {
    ...
    if (component.setAttribute) {
        component.setAttribute("id", "swatch_6jho0y");
    }
    if (scope.componentsFor["swatch"]) {
       scope.componentsFor["swatch"].setAttribute("for", "swatch_6jho0y")
    }
    parents[parents.length] = parent; parent = node;
    // DIV
    node = parent; parent = parents[parents.length - 1]; parents.length--;
...
var $THIS = function DelfEssaysDiggerCursormode(body, caller) {
    ...
    if (component.setAttribute) {
        component.setAttribute("id", "element_g933xt");
    }
    if (scope.componentsFor["element"]) {
       scope.componentsFor["element"].setAttribute("for", "element_g933xt")
    }
    if (component.setAttribute) {
    ...
    // DIV
        ...
        if (component.setAttribute) {
            component.setAttribute("id", "digButton_oe5aul");
        }
        if (scope.componentsFor["digButton"]) {
           scope.componentsFor["digButton"].setAttribute("for", "digButton_oe5aul")
        }
        if (component.setAttribute) {
        ...
        if (component.setAttribute) {
            component.setAttribute("id", "fillButton_7gzjcu");
        }
        if (scope.componentsFor["fillButton"]) {
           scope.componentsFor["fillButton"].setAttribute("for", "fillButton_7gzjcu")
        }
        if (component.setAttribute) {
        component.setAttribute("class", "button");
        }
        ...
        if (component.setAttribute) {
            component.setAttribute("id", "originButton_4i77wy");
        }
        if (scope.componentsFor["originButton"]) {
           scope.componentsFor["originButton"].setAttribute("for", "originButton_4i77wy")
        }
        if (component.setAttribute) {
        component.setAttribute("class", "button");
        }
        ...
        if (component.setAttribute) {
            component.setAttribute("id", "moveButton_kce0tj");
        }
        if (scope.componentsFor["moveButton"]) {
           scope.componentsFor["moveButton"].setAttribute("for", "moveButton_kce0tj")
        }
        if (component.setAttribute) {
        component.setAttribute("class", "button");
        }
        ...
        if (component.setAttribute) {
            component.setAttribute("id", "creepButton_i82f5p");
        }
        if (scope.componentsFor["creepButton"]) {
           scope.componentsFor["creepButton"].setAttribute("for", "creepButton_i82f5p")
        }
        if (component.setAttribute) {
        component.setAttribute("class", "button");
        }
        ...
        if (component.setAttribute) {
            component.setAttribute("id", "resizeButton_1hrizx");
        }
        if (scope.componentsFor["resizeButton"]) {
           scope.componentsFor["resizeButton"].setAttribute("for", "resizeButton_1hrizx")
        }
        if (component.setAttribute) {
        component.setAttribute("class", "button");
        }
        ...
        if (component.setAttribute) {
            component.setAttribute("id", "resizeToButton_d8aeul");
        }
        if (scope.componentsFor["resizeToButton"]) {
           scope.componentsFor["resizeToButton"].setAttribute("for", "resizeToButton_d8aeul")
        }
        if (component.setAttribute) {
        component.setAttribute("class", "button");
        }
        ...
        if (component.setAttribute) {
            component.setAttribute("id", "selectModeButton_265atg");
        }
        if (scope.componentsFor["selectModeButton"]) {
           scope.componentsFor["selectModeButton"].setAttribute("for", "selectModeButton_265atg")
        }
        if (component.setAttribute) {
        component.setAttribute("class", "button");
        }
        ...
        if (component.setAttribute) {
            component.setAttribute("id", "cutButton_5wbs4z");
        }
        if (scope.componentsFor["cutButton"]) {
           scope.componentsFor["cutButton"].setAttribute("for", "cutButton_5wbs4z")
        }
        if (component.setAttribute) {
        component.setAttribute("class", "button");
        }
        ...
        if (component.setAttribute) {
            component.setAttribute("id", "copyButton_vxyo3n");
        }
        if (scope.componentsFor["copyButton"]) {
           scope.componentsFor["copyButton"].setAttribute("for", "copyButton_vxyo3n")
        }
        if (component.setAttribute) {
        component.setAttribute("class", "button");
        }
        ...
        if (component.setAttribute) {
            component.setAttribute("id", "pasteButton_g388l7");
        }
        if (scope.componentsFor["pasteButton"]) {
           scope.componentsFor["pasteButton"].setAttribute("for", "pasteButton_g388l7")
        }
        if (component.setAttribute) {
        component.setAttribute("class", "button");
        }
        ...
        if (component.setAttribute) {
            component.setAttribute("id", "toggleButton_5vu99x");
        }
        if (scope.componentsFor["toggleButton"]) {
           scope.componentsFor["toggleButton"].setAttribute("for", "toggleButton_5vu99x")
        }
        if (component.setAttribute) {
        component.setAttribute("class", "button");
        }
        ...
        if (component.setAttribute) {
            component.setAttribute("id", "addButton_ye4m83");
        }
        if (scope.componentsFor["addButton"]) {
           scope.componentsFor["addButton"].setAttribute("for", "addButton_ye4m83")
        }
        if (component.setAttribute) {
        component.setAttribute("class", "button");
        }
        ...
        if (component.setAttribute) {
            component.setAttribute("id", "subButton_q5z01u");
        }
        if (scope.componentsFor["subButton"]) {
           scope.componentsFor["subButton"].setAttribute("for", "subButton_q5z01u")
        }
        if (component.setAttribute) {
        component.setAttribute("class", "button");
        }
...
var $THIS = function DelfEssaysDiggerDelf(body, caller) {
    ...
    if (component.setAttribute) {
        component.setAttribute("id", "styleSheet_vf8ye9");
    }
    if (scope.componentsFor["styleSheet"]) {
       scope.componentsFor["styleSheet"].setAttribute("for", "styleSheet_vf8ye9")
    }
    parents[parents.length] = parent; parent = node;
    // STYLE
    ...
    scope.hookup("container", component);
    if (component.setAttribute) {
        component.setAttribute("id", "container_vg4xmz");
    }
    if (scope.componentsFor["container"]) {
       scope.componentsFor["container"].setAttribute("for", "container_vg4xmz")
    }
    if (component.setAttribute) {
    ...
    // DIV
        ...
        if (component.setAttribute) {
            component.setAttribute("id", "viewport_33jr0g");
        }
        if (scope.componentsFor["viewport"]) {
           scope.componentsFor["viewport"].setAttribute("for", "viewport_33jr0g")
        }
        node = document.createElement("DIV");
        parent.appendChild(node);
        component = node.actualNode;
        ...
        if (component.setAttribute) {
            component.setAttribute("id", "colorLine_na4oll");
        }
        if (scope.componentsFor["colorLine"]) {
           scope.componentsFor["colorLine"].setAttribute("for", "colorLine_na4oll")
        }
        parents[parents.length] = parent; parent = node;
        // DIV
            node = document.createBody();
            ...
            if (component.setAttribute) {
                component.setAttribute("id", "colorPicker_dgc2q6");
            }
            if (scope.componentsFor["colorPicker"]) {
               scope.componentsFor["colorPicker"].setAttribute("for", "colorPicker_dgc2q6")
            }
        node = parent; parent = parents[parents.length - 1]; parents.length--;
        node = document.createElement("DIV");
        parent.appendChild(node);
        ...
        // DIV
            ...
            if (component.setAttribute) {
                component.setAttribute("id", "inventory_b8y1kf");
            }
            if (scope.componentsFor["inventory"]) {
               scope.componentsFor["inventory"].setAttribute("for", "inventory_b8y1kf")
            }
        node = parent; parent = parents[parents.length - 1]; parents.length--;
        node = document.createElement("DIV");
        parent.appendChild(node);
        ...
        // DIV
            ...
            if (component.setAttribute) {
                component.setAttribute("id", "cursorMode_a70f8i");
            }
            if (scope.componentsFor["cursorMode"]) {
               scope.componentsFor["cursorMode"].setAttribute("for", "cursorMode_a70f8i")
            }
            node = document.createBody();
            parent.appendChild(node);
            parents[parents.length] = parent; parent = node;
            ...
            if (component.setAttribute) {
                component.setAttribute("id", "knobMode_krlay4");
            }
            if (scope.componentsFor["knobMode"]) {
               scope.componentsFor["knobMode"].setAttribute("for", "knobMode_krlay4")
            }
            node = document.createBody();
            parent.appendChild(node);
            parents[parents.length] = parent; parent = node;
            ...
            if (component.setAttribute) {
                component.setAttribute("id", "fileMode_4rkqw2");
            }
            if (scope.componentsFor["fileMode"]) {
               scope.componentsFor["fileMode"].setAttribute("for", "fileMode_4rkqw2")
            }
        node = parent; parent = parents[parents.length - 1]; parents.length--;
    node = parent; parent = parents[parents.length - 1]; parents.length--;
    node = document.createElement("DIV");
    ...
    if (component.setAttribute) {
        component.setAttribute("id", "inspector_s3yt1w");
    }
    if (scope.componentsFor["inspector"]) {
       scope.componentsFor["inspector"].setAttribute("for", "inspector_s3yt1w")
    }
    if (component.setAttribute) {
...
var $THIS = function DelfEssaysDiggerFilemode(body, caller) {
    ...
    scope.hookup("element", component);
    if (component.setAttribute) {
        component.setAttribute("id", "element_6f9hjb");
    }
    if (scope.componentsFor["element"]) {
       scope.componentsFor["element"].setAttribute("for", "element_6f9hjb")
    }
    if (component.setAttribute) {
...
}],["essays/digger/index.js","delf/essays/digger","index.js",{"gutentag/document":37,"gutentag/scope":42,"blick":0,"./delf.html":24,"./cursor-mode":23},function (require, exports, module, __filename, __dirname){
...
var $THIS = function DelfEssaysDiggerInventory(body, caller) {
    ...
    if (component.setAttribute) {
        component.setAttribute("id", "items_2cob1a");
    }
    if (scope.componentsFor["items"]) {
       scope.componentsFor["items"].setAttribute("for", "items_2cob1a")
    }
    this.scope.hookup("this", this);
};
$THIS.prototype.exports = {};
...
var $THIS$0 = function DelfEssaysDiggerInventory$0(body, caller) {
    ...
    // DIV
        ...
        if (component.setAttribute) {
            component.setAttribute("id", "itemText_3sis7k");
        }
        if (scope.componentsFor["itemText"]) {
           scope.componentsFor["itemText"].setAttribute("for", "itemText_3sis7k")
        }
    node = parent; parent = parents[parents.length - 1]; parents.length--;
};
...
var $THIS = function DelfEssaysDiggerKnobmode(body, caller) {
    ...
    scope.hookup("element", component);
    if (component.setAttribute) {
        component.setAttribute("id", "element_iyouwr");
    }
    if (scope.componentsFor["element"]) {
       scope.componentsFor["element"].setAttribute("for", "element_iyouwr")
    }
    if (component.setAttribute) {
...
var $THIS = function DelfEssaysDiggerViewport(body, caller) {
    ...
    scope.hookup("element", component);
    if (component.setAttribute) {
        component.setAttribute("id", "element_6w89e1");
    }
    if (scope.componentsFor["element"]) {
       scope.componentsFor["element"].setAttribute("for", "element_6w89e1")
    }
    if (component.setAttribute) {
    ...
    // DIV
        ...
        scope.hookup("center", component);
        if (component.setAttribute) {
            component.setAttribute("id", "center_y4qsxc");
        }
        if (scope.componentsFor["center"]) {
           scope.componentsFor["center"].setAttribute("for", "center_y4qsxc")
        }
        if (component.setAttribute) {
        component.setAttribute("class", "center");
        }
        ...
        // DIV
            ...
            if (component.setAttribute) {
                component.setAttribute("id", "origin_6ofe56");
            }
            if (scope.componentsFor["origin"]) {
               scope.componentsFor["origin"].setAttribute("for", "origin_6ofe56")
            }
            if (component.setAttribute) {
            ...
            // DIV
                ...
                if (component.setAttribute) {
                    component.setAttribute("id", "cursor_df4ide");
                }
                if (scope.componentsFor["cursor"]) {
                   scope.componentsFor["cursor"].setAttribute("for", "cursor_df4ide")
                }
                if (component.setAttribute) {
                ...
                // DIV
                    ...
                    if (component.setAttribute) {
                        component.setAttribute("id", "knob_oiff9n");
                    }
                    if (scope.componentsFor["knob"]) {
                       scope.componentsFor["knob"].setAttribute("for", "knob_oiff9n")
                    }
                    if (component.setAttribute) {
